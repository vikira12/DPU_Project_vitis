set moduleName dpu_conv_top_Pipeline_POOL_OC_POOL_H_POOL_W
set isTopModule 0
...
set cdfgNum 7
set C_modelName {dpu_conv_top_Pipeline_POOL_OC_POOL_H_POOL_W}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "ofmap","offset": { "type": "dynamic","port_name": "ofmap","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "mul_ln82_1", "interface" : "wire", "bitwidth" : 22, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "mul_ln82", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ mul_ln82_1 sc_in sc_lv 22 signal 3 } 
	{ conv_scratch sc_in sc_lv 64 signal 4 } 
	{ lshr_ln1 sc_in sc_lv 7 signal 5 } 
	{ zext_ln85 sc_in sc_lv 7 signal 6 } 
	{ mul_ln82 sc_in sc_lv 14 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_ln82_1", "direction": "in", "datatype": "sc_lv", "bitwidth":22, "type": "signal", "bundle":{"name": "mul_ln82_1", "role": "default" }} , 
 	...
 	{ "name": "mul_ln82", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "mul_ln82", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "16451598"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "16451584"}
]}
...
set Spec2ImplPortList { 
	...
	mul_ln82_1 { ap_none {  { mul_ln82_1 in_data 0 22 } } }
	...
	mul_ln82 { ap_none {  { mul_ln82 in_data 0 14 } } }
}
