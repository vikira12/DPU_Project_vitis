set moduleName copy_passthrough_Pipeline_COPY_OC_COPY_H_COPY_W
set isTopModule 0
...
set cdfgNum 12
set C_modelName {copy_passthrough_Pipeline_COPY_OC_COPY_H_COPY_W}
...
set C_modelArgMapList {[ 
	{ "Name" : "bound7", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bound7 sc_in sc_lv 24 signal 0 } 
	...
	{ bound sc_in sc_lv 16 signal 5 } 
	{ ofmap sc_in sc_lv 64 signal 6 } 
	{ zext_ln119 sc_in sc_lv 8 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bound7", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "bound7", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "16581385"}
...
set Spec2ImplPortList { 
	bound7 { ap_none {  { bound7 in_data 0 24 } } }
