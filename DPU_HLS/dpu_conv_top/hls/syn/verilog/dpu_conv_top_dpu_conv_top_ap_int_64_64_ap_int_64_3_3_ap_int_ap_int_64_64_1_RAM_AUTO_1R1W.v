...
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module dpu_conv_top_dpu_conv_top_ap_int_64_64_ap_int_64_3_3_ap_int_ap_int_64_64_1_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 8,
    AddressRange = 131072,
    AddressWidth = 17,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        dpu_conv_top_dpu_conv_top_ap_int_64_64_ap_int_64_3_3_ap_int_ap_int_64_64_1_RAM_AUTO_1R1W_memcore dpu_conv_top_dpu_conv_top_ap_int_64_64_ap_int_64_3_3_ap_int_ap_int_64_64_1_RAM_AUTO_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .address0 ( buf_a0[i] ),
            .we0      ( buf_we0[i] ),
            .d0       ( buf_d0[i] ),
