...
entity dpu_conv_top_fifo_w32_d2_S is 
    generic (
...
architecture rtl of dpu_conv_top_fifo_w32_d2_S is
...
------------------------Component----------------------
    component dpu_conv_top_fifo_w32_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_dpu_conv_top_fifo_w32_d2_S_ShiftReg : dpu_conv_top_fifo_w32_d2_S_ShiftReg
    generic map (
...
entity dpu_conv_top_fifo_w32_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end dpu_conv_top_fifo_w32_d2_S_ShiftReg;

architecture rtl of dpu_conv_top_fifo_w32_d2_S_ShiftReg is
